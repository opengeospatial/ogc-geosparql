...
| geof:buffer | st_buffer | https://www.h2gis.org/docs/1.5.0/ST_Buffer/[ST_Buffer] | buffer
...
|  | st_addpoint | https://www.h2gis.org/docs/1.5.0/ST_AddPoint/[ST_AddPoint] | addpoint
|  |  |  | addtemporarygeometrycolumn
|  | st_asbinary | https://www.h2gis.org/docs/1.5.0/ST_AsBinary/[ST_AsBinary] | asbinary
|  |  |  | asencodedpolyline
...
|  |  |  | autogpkgstart
|  |  |  | autogpkgstop
|  | st_azimuth | https://www.h2gis.org/docs/1.5.0/ST_Azimuth/[ST_Azimuth] | azimuth
...
|  |  |  | circularity
|  |  |  | clonetable
|  | st_closestpoint | https://www.h2gis.org/docs/1.5.0/ST_ClosestPoint/[ST_ClosestPoint] | closestpoint
|  | https://postgis.net/docs/ST_Collect.html[ST_Collect] | https://www.h2gis.org/docs/1.5.0/ST_Collect/[ST_Collect] | collect
|  | st_collectionextract | https://www.h2gis.org/docs/1.5.0/ST_CollectionExtract/[ST_CollectionExtract] | collectionextract
|  |  |  | compressgeometry
...
|  |  |  | eval
|  |  |  | exp
|  | st_expand | https://www.h2gis.org/docs/1.5.0/ST_Expand/[ST_Expand] | expand
|  |  |  | exportdbf
|  |  |  | exportdxf
|  |  |  | exportgeojson2
| geof:asKML |  |  | exportkml
|  |  |  | exportshp
|  | st_extent | https://www.h2gis.org/docs/1.5.0/ST_Extent/[ST_Extent] | extent
