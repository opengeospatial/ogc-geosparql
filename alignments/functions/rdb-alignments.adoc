...
| geof:asGML | https://postgis.net/docs/ST_AsGML.html[ST_AsGML] | st_asgml | asgml
| geof:asKML | https://postgis.net/docs/ST_AsKML.html[ST_AsKML] |  | askml
| geof:asWKT | https://postgis.net/docs/ST_AsText.html[ST_AsText] | st_aswkt | aswkt
...
| geof:centroid | https://postgis.net/docs/ST_Centroid.html[ST_Centroid] | st_centroid | centroid
| geof:concaveHull | https://postgis.net/docs/ST_ConcaveHull.html[ST_ConcaveHull] |  | concavehull
| geof:contains | https://postgis.net/docs/ST_Contains.html[ST_Contains] | st_contains | contains
| geof:convexHull | https://postgis.net/docs/ST_ConvexHull.html[ST_ConvexHull] | st_convexhull | convexhull
| geof:coveredBy | https://postgis.net/docs/ST_CoveredBy.html[ST_CoveredBy] |  | coveredby
| geof:covers | https://postgis.net/docs/ST_Covers.html[ST_Covers] | st_covers | covers
| geof:crosses | https://postgis.net/docs/ST_Crosses.html[ST_Crosses] | st_crosses | crosses
| geof:difference | https://postgis.net/docs/ST_Difference.html[ST_Difference] | st_difference | difference
| geof:disjoint | https://postgis.net/docs/ST_Disjoint.html[ST_Disjoint] | st_disjoint | mbrdisjoint
| geof:distance | https://postgis.net/docs/ST_Distance.html[ST_Distance] | st_distance | distance
| geof:envelope | https://postgis.net/docs/ST_Envelope.html[ST_Envelope] | st_envelope | envelope
| geof:equals | https://postgis.net/docs/ST_Equals.html[ST_Equals] | st_equals | equals
...
| geof:intersection | https://postgis.net/docs/ST_Intersection.html[ST_Intersection] | st_intersection | intersection
