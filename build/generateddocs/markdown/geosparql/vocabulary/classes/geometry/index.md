...
# GeoSPARQL Geometry (Model)

`ogc.geosparql.vocabulary.classes.geometry` *v0.1*

A building block defining a GeoSPARQL Geometry
...
* Path: `_sources/vocabulary/classes/geometry`
