...
### rcc8ec relation example
A feature is related to another feature using the geo:rcc8ec relation.
#### ttl
```ttl
@prefix ex: <http://example.org/ApplicationSchema#> .
@prefix geo: <http://www.opengis.net/ont/geosparql#> .
...
### rcc8ntppi and rcc8ntpp relation example
A feature is related to another feature using the geo:rcc8ntppi relation. The inverse relation rccntpp is documented as well.
#### ttl
```ttl
@prefix ex: <http://example.org/ApplicationSchema#> .
@prefix geo: <http://www.opengis.net/ont/geosparql#> .
