...
|```geof:rcc9eq(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(TFFF*FFFT)+`
| ```geof:rcc9cr(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(T*TFFTT**)+ v +(TFT*F*TT*)+ v +(TFTFFFTFT)+ v +(TTTFFFTTT)+ v +(TFTTFTTFT)+`
| ```geof:rcc9dc(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(FF*FF****)+`
| ```geof:rcc9ec(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(F*TT**T**)+ v +(FTT***T**)+ v +(F*T*T*T**)+`
| ```geof:rcc9po(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(TTTT**T**)+ v +(T*T*T*T**)+`
| ```geof:rcc9tppi(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(***T**FF*)+ v +(****T*FF*)+ v ¬+(TFFFTFFFT)+`
| ```geof:rcc9tpp(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(*TF**F***)+ v +(**F*TF***)+ v ¬+(TFFFTFFFT)+`
| ```geof:rcc9ntpp(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(*FF*FFT**)+`
| ```geof:rcc9ntppi(geom1: ogc:geomLiteral,
                geom2: ogc:geomLiteral): xsd:boolean``` | `+(**TFF*FF*)+`
|===
