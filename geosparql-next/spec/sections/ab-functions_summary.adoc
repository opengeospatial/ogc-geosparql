...
CellList (DGGS) 
| <<Function: geof:easting, easting>> | 1x ogc:geomLiteral | Point | http://www.w3.org/2001/XMLSchema#double[xsd:double] |
...
| <<Function: geof:northing, northing>> | 1x ogc:geomLiteral | Point | http://www.w3.org/2001/XMLSchema#double[xsd:double] |
...
| *Function* | *Input Datatypes* | *Input Subtypes* | *Output Datatype* | *Output Subtype*
| <<Function: geof:extrude, extrude>> | 2x ogc:geomLiteral |  1x Polygon, 1 x LineString | geo:Feature |
| <<Function: geof:extrudeToHeight, extrudeToHeight>> | 1x ogc:geomLiteral, 1x http://www.w3.org/2001/XMLSchema#string[xsd:double] |  1x Polygon | geo:Feature |
| <<Function: geof:extrudeInTime, extrudeInTime>> | 2x ogc:geomLiteral, 2x http://www.w3.org/2001/XMLSchema#string[xsd:dateTime] |  1x Polygon, 1 x LineString | geo:Feature  |
...
| <<Function: geof:asWKT, asGeoCode>> | 1x ogc:geomLiteral | Geometry | geo:geocodeLiteral |
