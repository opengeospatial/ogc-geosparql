...
====
The IRI http://www.opengis.net/def/crs/OGC/1.3/CRS84[{lt}http://www.opengis.net/def/crs/OGC/1.3/CRS84{gt}] shall be assumed as the spatial reference system for <<rdfs_datatype_geo_wktliteral, `geo:wktLiteral`>> instances that do not specify an explicit spatial reference system IRI.
====
...
====
The IRI http://www.opengis.net/def/crs/OGC/1.3/CRS84[{lt}http://www.opengis.net/def/crs/OGC/1.3/CRS84{gt}] shall be assumed as the spatial reference system for <<rdfs_datatypes_geo_ewkbliteral, `geo:ewkbLiteral`>> instances that do not specify an explicit spatial reference system IRI. IRIs defined as SRIDs in an Extended Well-Known Binary format shall be ignored.
====
