...
requirement:: /req/geometry-topology-extension/rcc9-query-functions
====

[[geometry_topology_extension_parameters]]
=== Parameters
...
<<req_geometry-topology-extension_relate-query-function, `geof:relate`>>
...
[[geometry_topology_extension_simple_features_relation_family]]
...
|`geof:sfEquals(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFFTFFFT)]`
|`geof:sfDisjoint(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FF*FF****)]`
|`geof:sfIntersects(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FT******* F**T***** F***T****)]`
|`geof:sfTouches(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FT******* F**T***** F***T****)]`
|`geof:sfCrosses(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*T***T**) for P/L, P/A, L/A; (0*T***T**) for L/L]`
|`geof:sfWithin(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*F**F***)]`
|`geof:sfContains(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*****FF*)]`
|`geof:sfOverlaps(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*T***T**) for A/A, P/P; (1*T***T**) for L/L]`
|===

[[geometry_topology_extension_egenhofer_relation_family]]
...
|`geof:ehEquals(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFFTFFFT)]`
|`geof:ehDisjoint(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FF*FF****)]`
|`geof:ehMeet(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FT******* F**T***** F***T****)]`
|`geof:ehOverlap(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*T***T**)]`
|`geof:ehCovers(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*TFT*FF*)]`
|`geof:ehCoveredBy(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFF*TFT**)]`
|`geof:ehInside(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFF*FFT**)]`
|`geof:ehContains(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*TFF*FF*)]`
|===

[[rcc8_relation_family]]
...
|`geof:rcc8eq(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFFTFFFT)]`
|`geof:rcc8dc(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FFTFFTTTT)]`
|`geof:rcc8ec(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FFTFTTTTT)]`
|`geof:rcc8po(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TTTTTTTTT)]`
|`geof:rcc8tppi(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TTTFTTFFT)]`
|`geof:rcc8tpp(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFTTFTTT)]`
|`geof:rcc8ntpp(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFTFFTTT)]`
|`geof:rcc8ntppi(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TTTFFTFFT)]`
|===

[[rcc_9_relation_family]]
=== RCC*-9 Relation Family

This clause establishes Requirements for the _RCC*-9_ relation family. Consult references <<RCC9>> for a more detailed discussion of _RCC*-9_ relations.

[[req_geometry-topology-extension_rcc9-query-functions]]
[requirement,identifier="/req/geometry-topology-extension/rcc9-query-functions"]
.RCC*-9 Query Functions
====
Implementations shall support
http://www.opengis.net/def/function/geosparql/rcc9eq[`geof:rcc9eq`],
http://www.opengis.net/def/function/geosparql/rcc9dc[`geof:rcc9dc`],
http://www.opengis.net/def/function/geosparql/rcc9cr[`geof:rcc9cr`],
http://www.opengis.net/def/function/geosparql/rcc9ec[`geof:rcc9ec`],
http://www.opengis.net/def/function/geosparql/rcc9po[`geof:rcc9po`],
http://www.opengis.net/def/function/geosparql/rcc9tppi[`geof:rcc9tppi`],
http://www.opengis.net/def/function/geosparql/rcc9tpp[`geof:rcc9tpp`],
http://www.opengis.net/def/function/geosparql/rcc9ntpp[`geof:rcc9ntpp`] and
http://www.opengis.net/def/function/geosparql/rcc9ntppi[`geof:rcc9ntppi`]
as SPARQL extension functions, consistent with their corresponding DE-9IM intersection patterns, as defined by Simple Features <<OGCSFACA>> <<ISO19125-1>>.
====

Boolean query functions defined for the _RCC*-9_ relation family, along with their associated DE-9IM intersection patterns, are shown in <<rcc9_query_functions>> below. Each function accepts two arguments (`geom1` and `geom2`) of the geometry literal serialization type specified by _serialization_ and _version_. Each function returns an http://www.w3.org/2001/XMLSchema#boolean[`xsd:boolean`] value of `true` if the specified relation exists between `geom1` and `geom2` and returns `false` otherwise. In each case, the spatial reference system of geom1 is used for spatial calculations.

[[rcc9_query_functions]]
.RCC*-9 Query Functions
|===
|Query Function | Defining DE-9IM Intersection Pattern

|`geof:rcc9eq(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TFFF*FFFT)]`
|`geof:rcc9cr(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(T*TFFTT**) v (TFT*F*TT*) v (TFTFFFTFT) v (TTTFFFTTT) v (TFTTFTTFT)]`
|`geof:rcc9dc(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(FF*FF****)]`
|`geof:rcc9ec(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(F*TT**T**) v (FTT***T**) v (F*T*T*T**)]`
|`geof:rcc9po(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(TTTT**T**) v (T*T*T*T**)]`
|`geof:rcc9tppi(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(***T**FF*) v (****T*FF*) v ¬(TFFFTFFFT)]`
|`geof:rcc9tpp(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(*TF**F***) v (**F*TF***) v ¬(TFFFTFFFT)]`
|`geof:rcc9ntpp(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(*FF*FFT**)]`
|`geof:rcc9ntppi(geom1: ogc:geomLiteral, geom2: ogc:geomLiteral): xsd:boolean` | `pass:[(**TFF*FF*)]`
|===
