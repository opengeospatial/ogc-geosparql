...
====
Implementations shall allow the properties
<<Property:geo:rcc9eq, `geo:rcc9eq`>>,
<<Property:geo:rcc9dc, `geo:rcc9dc`>>,
<<Property:geo:rcc9ec, `geo:rcc9ec`>>,
<<Property:geo:rcc9po, `geo:rcc9po`>>,
<<Property:geo:rcc9tppi, `geo:rcc9tppi`>>,
<<Property:geo:rcc9tpp, `geo:rcc9tpp`>>,
<<Property:geo:rcc9ntpp, `geo:rcc9ntpp`>>,
<<Property:geo:rcc9ntppi, `geo:rcc9ntppi`>> ,
<<Property:geo:rcc9cr, `geo:rcc9cr`>>,
to be used in SPARQL graph patterns.
====
...
|[[Property:geo:rcc9eq]]equals | http://www.opengis.net/ont/geosparql#rcc9eq[`geo:rcc9eq`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TFFF*FFFT)`
|[[Property:geo:rcc9dc]]disconnected | http://www.opengis.net/ont/geosparql#rcc9dc[`geo:rcc9dc`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(FF*FF****)`
|[[Property:geo:rcc9ec]]externally connected | http://www.opengis.net/ont/geosparql#rcc9ec[`geo:rcc9ec`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(F*TT**T**) v (FTT***T**) v (F*T*T*T**)`
|[[Property:geo:rcc9po]]partially overlapping | http://www.opengis.net/ont/geosparql#rcc9po[`geo:rcc9po`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TTTT**T**) v (T*T*T*T**)`
|[[Property:geo:rcc9tppi]]tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc9tppi[`geo:rcc9tppi`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A`  | `(***T**FF*) v (****T*FF*) v ¬(TFFFTFFFT)`
|[[Property:geo:rcc9tpp]]tangential proper part | http://www.opengis.net/ont/geosparql#rcc9tpp[`geo:rcc9tpp`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(*TF**F***) v (**F*TF***) v ¬(TFFFTFFFT)`
|[[Property:geo:rcc9ntpp]]non-tangential proper part | http://www.opengis.net/ont/geosparql#rcc9ntpp[`geo:rcc9ntpp`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(*FF*FFT**)`
|[[Property:geo:rcc9ntppi]]non-tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc9ntppi[`geo:rcc9ntppi`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(**TFF*FF*)`
|[[Property:geo:rcc9cr]]crosses | http://www.opengis.net/ont/geosparql#rcc9cr[`geo:rcc9cr`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TFFF*FFFT)`
|===
...
|<<Property:geo:sfEquals, equals>> | <<Property:geo:rcc8eq, equals>> | <<Property:geo:ehEquals, equals>>
|<<Property:geo:sfDisjoint, disjoint>> | <<Property:geo:rcc8dc, disconnected>> | <<Property:geo:ehDisjoint, disjoint>>
|<<Property:geo:sfIntersects, intersects>> | `¬` <<Property:geo:rcc8dc, disconnected>> | `¬` <<Property:geo:ehDisjoint, disjoint>>
|<<Property:geo:sfTouches, touches>> | <<Property:geo:rcc8ec, externally connected>> | <<Property:geo:ehMeet, meet>>
|<<Property:geo:sfWithin, within>> | <<Property:geo:rcc8ntpp, non-tangential proper part>> `+` <<Property:geo:rcc8tpp, tangential proper part>> | <<Property:geo:ehInside, inside>> `+` <<Property:geo:ehCoveredBy, covered by>>
|<<Property:geo:sfContains, contains>> | <<Property:geo:rcc8ntppi, non-tangential proper part inverse>> `+` <<Property:geo:rcc8tppi, tangential proper part inverse>> | <<Property:geo:ehContains, contains>> `+` <<Property:geo:ehCovers, covers>>
|<<Property:geo:sfOverlaps, overlaps>> | <<Property:geo:rcc8po, partially overlapping>> | <<Property:geo:ehOverlap, overlap>>
|===
