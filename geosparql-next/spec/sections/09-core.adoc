...
Two main classes are defined: <<Class: geo:SpatialObject, `geo:SpatialObject`>> and <<Class: geo:Feature, Feature>>.
...
.Feature Class
====
Implementations shall allow the RDFS class <<Class: geo:Feature, Feature>> to be used in SPARQL graph patterns.
====
...
Membership of the generic  http://www.w3.org/2000/01/rdf-schema#Container[`rdfs:Container`] that defines this class is restricted to instances of <<Class: geo:SpatialObject, Spatial Object>>. <<Class: geo:SpatialObjectCollection, Spatial Object Collection>> members are to be indicated with the  http://www.w3.org/2000/01/rdf-schema#member[`rdfs:member`] property.
...
====
Implementations shall allow the RDFS class <<Class: geo:SpatialObjectCollection, Spatial Object Collection>> to be used in SPARQL graph patterns.
====
...
This class is indicated to be a collection of spatial objects by being a subclass of the general <<Class: geo:SpatialObjectCollection, Spatial Object Collection>>. That it contains only <<Class: geo:Feature, Feature>> class instances is indicated by the restriction http://www.w3.org/2000/01/rdf-schema#member[`rdfs:member`] predicate. That a it can be used as a Feature, for example as the domain value for the <<Property: geo:hasGeometry, has geometry>> predicate, is indicated by it being a subclass of the <<Class: geo:Geometry, Geometry>> class.
...
====
Implementations shall allow the RDFS class <<Class: geo:FeatureCollection, Feature Collection>> to be used in SPARQL graph patterns.
====
...
Properties are defined for associating <<Class: geo:Feature, Feature>> instances with <<Class: geo:Geometry, `geo:Geometry`>> instances.
