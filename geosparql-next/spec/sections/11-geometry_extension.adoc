...
.asDGGS Function
====
Implementations shall support <<Function: geof:asDGGS, `geof:asDGGS`>> and <<Function: geof:asDGGSResolution, `geof:asDGGSResolution`>>  as a SPARQL extension function.
====
...
====
Implementations shall support the functions
<<Function: geof:extrude, `geof:extrude`>> <<Function: geof:extrude, `geof:extrudeByLine`>> <<Function: geof:extrudeInTime, `geof:extrudeInTime`>>
