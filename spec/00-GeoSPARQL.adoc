...
include::aa_abstract_test_suite.adoc[]

include::ab_functions_summary.adoc[]

include::ac_examples.adoc[]

include::ad_shacl_shapes.adoc[]

include::ae_alignments.adoc[]

include::af_cql_geosparql_mapping.adoc[]

include::ag_alignments.adoc[]
