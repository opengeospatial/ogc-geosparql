...
include::03-title.adoc[]

:sectnums:

include::04-scope.adoc[]

include::05-conformance.adoc[]

include::06-normative-references.adoc[]

include::07-terms-definitions.adoc[]

include::08-conventions.adoc[]

include::09-core.adoc[]

include::10-topology-extension.adoc[]

include::11-geometry-extension.adoc[]

include::12-geometry-topology-extension.adoc[]

include::13-rdfs-entailment-extension.adoc[]

include::14-query-rewrite-extension.adoc[]

include::15-future-work.adoc[]

:sectnums!:

include::aa-abstract-test-suite.adoc[]

include::ab-functions-summary.adoc[]

include::ac-examples.adoc[]

include::ad-shacl-shapes.adoc[]

include::ae-alignments.adoc[]

include::af-cql-geosparql-mapping.adoc[]

include::ag-revision-history.adoc[]

include::az-bibliography.adoc[]
