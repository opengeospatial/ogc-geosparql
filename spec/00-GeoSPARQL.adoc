...
include::03-scope.adoc[]

:sectnums:

include::04-conformance.adoc[]

include::05-references.adoc[]

include::06-terms_and_definitions.adoc[]

include::07-conventions.adoc[]

include::08-title.adoc[]

include::09-core.adoc[]

include::10-topology_extension.adoc[]

include::11-geometry_extension.adoc[]

include::12-geometry_topology_extension.adoc[]

include::13-rdfs_entailment_extension.adoc[]

include::14-query_rewrite_extension.adoc[]

include::15-future_work.adoc[]

:sectnums!:

include::aa-abstract_test_suite.adoc[]

include::ab-functions_summary.adoc[]

include::ac-examples.adoc[]

include::ad-shacl_shapes.adoc[]

include::ae-alignments.adoc[]

include::af-cql_geosparql_mapping.adoc[]

include::ag-revision_history.adoc[]
