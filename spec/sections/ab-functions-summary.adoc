...
| *Function* | *Input Datatypes* | *Input Subtypes* | *Output Datatype* | *Output Subtype* 
| <<Function: geof:aggBoundingBox, aggBoundingBox>> | 1 or more ogc:geomLiteral | | ogc:geomLiteral | rectangular Polygon (not DGGS), 
...
CellList (DGGS) 
| <<Function: geof:aggUnion, aggUnion>> | 1 or more ogc:geomLiteral | | ogc:geomLiteral | (Multi)Point, (Multi)LineString, (Multi)Polygon (not DGGS),
...
1x http://www.w3.org/2001/XMLSchema#anyURI[xsd:anyURI] | any | ogc:geomLiteral | Polygon (not DGGS),
...
| <<Function: geof:intersection, intersection>> | 2x ogc:geomLiteral | 2x Geometry | ogc:geomLiteral | (Multi)Polygon (not DGGS),
...
| <<Function: geof:union, union>> | 2x ogc:geomLiteral | 2x Geometry | ogc:geomLiteral | (Multi)Point, (Multi)LineString, (Multi)Polygon (not DGGS),
