...
| Violation
| Each node with an incoming <<Property: hasGeometry, geo:hasGeometry>>, or a specialization of it, should have at minimum one outgoing relation that is either <<Property: hasSerialization, geo:hasSerialization>>, or a specialization of it.
...
| Violation
| Each node with an incoming <<Property: hasGeometry, geo:hasGeometry>>, or a specialization of it, can have a maximum of one outgoing <<Property: asWKT,  geo:asWKT>> relation.
...
| Violation
| Each node with an incoming <<Property: hasGeometry, geo:hasGeometry>>, or a specialization of it, can have a maximum of one outgoing <<Property: asGML, geo:asGML>> relation.
...
| Violation 
| Each node with an incoming <<Property: hasGeometry, geo:hasGeometry>>, or a specialization of it, can have a maximum of one outgoing  <<Property: asGeoJSON,  geo:asGeoJSON>>  relation.
...
| Violation
| Each node with an incoming <<Property: hasGeometry, geo:hasGeometry>>, or a specialization of it, can have a maximum of one outgoing <<Property: asKML, geo:asKML>> relation.
...
| Violation
| Each node with one or more outgoing relations that are either <<Property: hasSerialization, geo:hasSerialization>>, or a specialization of it, should have at least one incoming <<Property: hasGeometry, geo:hasGeometry>> relation or a specialization of it.
...
| Violation
| A node that has an incoming <<Property: hasGeometry, geo:hasGeometry>> property, or specialization of it, cannot have an outgoing <<Property: hasGeometry, geo:hasGeometry>> property, or a specialization of, it at the same time (a <<Feature, Feature>> cannot be a <<Geometry, Geometry>> at the same time)
| <<req_core_feature-properties>>

|http://www.opengis.net/def/geosparql/validator/S4-hasSerialization-literal[Shape 4]
| Violation
| The target of a <<Property: hasSerialization, geo:hasSerialization>> property, or a specialization of, it should be an RDF literal
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S5-asWKT-wktLiteral[Shape 5]
| Violation
| The target of a <<Property: asWKT, geo:asWKT>> property should be an RDF literal with datatype http://www.opengis.net/ont/geosparql#wktLiteral[geo:wktLiteral]
| xref:/req/geometry-extension/wkt-literal[]

|http://www.opengis.net/def/geosparql/validator/S6-asGML-gmlLiteral[Shape 6]
| Violation
| The target of a <<Property: asGML, geo:asGML>> property should be an RDF literal with datatype http://www.opengis.net/ont/geosparql#gmlLiteral[geo:gmlLiteral]
| xref:/req/geometry-extension/gml-literal[]

|http://www.opengis.net/def/geosparql/validator/S7-asGeoJSON-geoJSONLiteral[Shape 7]
| Violation
| The target of a <<Property: asGeoJSON, geo:asGeoJSON>> property should be an RDF literal with datatype http://www.opengis.net/ont/geosparql#geoJSONLiteral[geo:geoJSONLiteral]
| xref:/req/geometry-extension/geojson-literal[]

|http://www.opengis.net/def/geosparql/validator/S8-asKML-kmlLiteral[Shape 8]
| Violation
| The target of a <<Property: asKML, geo:asKML>> property should be an RDF literal with datatype http://www.opengis.net/ont/geosparql#kmlLiteral[geo:kmlLiteral]
...
| Violation
| A <<Geometry, Geometry>> node should have a maximum of one outgoing http://www.opengis.net/ont/geosparql#coordinateDimension[geo:coordinateDimension] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S10-many-dimension-one[Shape 10]
| Violation
| A <<Geometry, Geometry>> node should have a maximum of one outgoing http://www.opengis.net/ont/geosparql#dimension[geo:dimension] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S11-many-isEmpty-one[Shape 11]
| Violation
| A <<Geometry, Geometry>> node should have a maximum of one outgoing http://www.opengis.net/ont/geosparql#isEmpty[geo:isEmpty] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S12-many-isSimple-one[Shape 12]
| Violation
| A <<Geometry, Geometry>> node should have a maximum one outgoing http://www.opengis.net/ont/geosparql#isSimple[geo:isSimple] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S13-many-spatialDimension-one[Shape 13]
| Violation
| A <<Geometry, Geometry>> node should have maximum of one outgoing http://www.opengis.net/ont/geosparql#spatialDimension[geo:spatialDimension] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S14a-many-hasSpatialResolution-one[Shape 14a]
| Violation
| A <<Geometry, Geometry>> node should have maximum of one outgoing http://www.opengis.net/ont/geosparql#hasSpatialResolution[geo:hasSpatialResolution] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S14b-many-hasSpatialAccuracy-one[Shape 14b]
| Violation
| A <<Geometry, Geometry>> node should have maximum of one outgoing http://www.opengis.net/ont/geosparql#hasSpatialAccuracy[geo:hasSpatialAccuracy] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S14c-many-hasMetricAccuracy-one[Shape 14c]
| Violation
| A <<Geometry, Geometry>> node should have maximum of one outgoing http://www.opengis.net/ont/geosparql#hasMetricSpatialAccuracy[geo:hasMetricSpatialAccuracy] property
| xref:/req/geometry-extension/geometry-properties[]

|http://www.opengis.net/def/geosparql/validator/S14d-many-hasMetricResolution-one[Shape 14d]
| Violation
| A <<Geometry, Geometry>> node should have maximum of one outgoing http://www.opengis.net/ont/geosparql#hasMetricSpatialResolution[geo:hasMetricSpatialResolution] property
| xref:/req/geometry-extension/geometry-properties[]
...
| Violation
| An instance of <<FeatureCollection, FeatureCollection>> should have at least one outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] relation
...
| Violation
| An instance of <<FeatureCollection, FeatureCollection>> should only have outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] going to <<Feature, Feature>> instances
| xref:/req/core/feature-collection-class[]

|http://www.opengis.net/def/geosparql/validator/S22-GeometryCollectionClass-minOneMember-geometry-sub[Shape 22a]
| Violation
| An instance of <<GeometryCollection, GeometryCollection>> should have at least one outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] relation
...
| Violation
| An instance of <<GeometryCollection, GeometryCollection>> should only have outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] relations to <<Geometry, Geometry>> instances
| <<req_geometry_extension_geometry-collection-class>>

|http://www.opengis.net/def/geosparql/validator/S23-SpatialObjectCollection-minOneMember-spatialObject-sub[Shape 23a]
| Violation
| An instance of <<SpatialObjectCollection, SpatialObjectCollection>> should have at least one outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] relation
...
| Violation
| An instance of <<SpatialObjectCollection, SpatialObjectCollection>> should only have outgoing http://www.w3.org/2000/01/rdf-schema#member[rdfs:member] relations going to <<SpatialObject, SpatialObject>> instances, or subclasses of them
| xref:/req/core/spatial-object-collection-class[]
|===
