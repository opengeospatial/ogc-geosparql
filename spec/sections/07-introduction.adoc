...
** **Includes normative <<RDF, RDF>> & <<OWL, OWL>> ontology element definitions, conformance requirements and function signatures based on the General Feature Model cite:[ISO19109], Simple Features cite:[OGCSFACA] cite:[ISO19125-1] and SQL cite:[ISO13249];**
** **Also includes non-normative examples and mappings to other modelling and function systems.**
3. Domain model <<RDF, RDF>>/<<OWL, OWL>> schema
** http://www.opengis.net/ont/geosparql;
** For geographic information representation;
** An RDF data file matching the definition within the specification document.
4. Functions & Rules vocabularies
** http://www.opengis.net/def/function/geosparql;
** http://www.opengis.net/def/rule/geosparql;
** Derived from the ontology;
** Presented as SKOS cite:[SKOS] taxonomies.
...
** Presented as an OWL cite:[OWL2] ontology.
...
** Defined using SHACL cite:[SHACL];
