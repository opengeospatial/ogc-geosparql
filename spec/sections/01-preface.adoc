...
* The terms <<spatial_reference_system, Spatial Reference System (SRS)>> and <<coordinate_reference_system, Coordinate Reference System (CRS)>> are no longer interchangeable. Spatial Reference System is now taken to be a broader category than Coordinate Reference System. These are defined in <<terms_and_definitions>>.
...
* A section was added <<recommendation_for_units_of_measure, recommending particular use of units of measurement>>.
...
| Nicholas J. Car | formerly SURROUND Australia Pty Ltd. now https://kurrawong.ai[KurrawongAI]
|===
