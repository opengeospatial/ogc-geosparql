...
The Dimensionally Extended Nine Intersection Model (DE-9IM) cite:[DE-9IM] has been used to define the relation tested by the query functions introduced in this section. Each query function is associated with a defining DE-9IM intersection pattern. Possible pattern values are:
...
http://www.opengis.net/def/function/geosparql/sfEquals[`geof:relate`]
as a SPARQL extension function, consistent with the relate operator defined in Simple Features cite:[OGCSFACA] cite:[ISO19125-1].
====
...
as SPARQL extension functions, consistent with their corresponding DE-9IM intersection patterns, as defined by Simple Features cite:[OGCSFACA] cite:[ISO19125-1].
====
...
This clause establishes Requirements for the _Egenhofer_ relation family. Consult references cite:[FORMAL] and cite:[CATEG] for a more detailed discussion of _Egenhofer_ relations.
...
This clause establishes Requirements for the _RCC8_ relation family. Consult references cite:[QUAL] and cite:[LOGIC] for a more detailed discussion of _RCC8_ relations.
