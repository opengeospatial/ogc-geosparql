...
This clause defines Requirements for the 9-intersection model for the binary topological relations (_Egenhofer_) relation family. The reader should consult references cite:[FORMAL] and cite:[CATEG] for a more detailed discussion of _Egenhofer_ relations.
...
This clause defines Requirements for the region connection calculus basic 8 (_RCC8_) relation family. The reader should consult references cite:[QUAL] and cite:[LOGIC] for a more detailed discussion of _RCC8_ relations.
