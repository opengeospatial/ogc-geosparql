...
<<sfCrosses, sfCrosses>>,
<<sfWithin, sfWithin>>,
<<sfContains, sfContains>> and
<<sfOverlaps, sfOverlaps>>
to be used in SPARQL graph patterns.
====

Topological relations in the _Simple Features_ family are summarized in <<sf_relations, sf_relations>>. Multi-row intersection patterns should be interpreted as a logical `OR` of each row.
...
|[[sfEquals]]equals | http://www.opengis.net/ont/geosparql#sfEquals[`geo:sfEquals`] | <<SpatialObject, SpatialObject>> | `All` | `(TFFFTFFFT)`
|[[sfDisjoint]]disjoint | http://www.opengis.net/ont/geosparql#sfDisjoint[`geo:sfDisjoint`] | <<SpatialObject, SpatialObject>> | `All` | `+(FF**FF****)+`
|[[sfIntersects]]intersects | http://www.opengis.net/ont/geosparql#sfIntersects[`geo:sfIntersects`] | <<SpatialObject, SpatialObject>> | `All` | `+(T******** *T******* ***T***** ****T****)+`
|[[sfTouches]]touches | http://www.opengis.net/ont/geosparql#sfTouches[`geo:sfTouches`] | <<SpatialObject, SpatialObject>> | `All except P/P` | `+(FT******* F**T***** F***T****)+`
|[[sfWithin]]within | http://www.opengis.net/ont/geosparql#sfWithin[`geo:sfWithin`] | <<SpatialObject, SpatialObject>> | `All` | `+(T*F**F***)+`
|[[sfContains]]contains | http://www.opengis.net/ont/geosparql#sfContains[`geo:sfContains`] | <<SpatialObject, SpatialObject>> | `All` | `+(T*****FF*)+`
|[[sfOverlaps]]overlaps | http://www.opengis.net/ont/geosparql#sfOverlaps[`geo:sfOverlaps`] | <<SpatialObject, SpatialObject>> | `A/A, P/P, L/L` | `+(T*T***T**) for A/A, P/P+`; `+(1*T***T**) for L/L+`
|[[sfCrosses]]crosses | http://www.opengis.net/ont/geosparql#sfCrosses[`geo:sfCrosses`] | <<SpatialObject, SpatialObject>> | `P/L, P/A, L/A, L/L` | `+(T*T***T**) for P/L, P/A,
L/A+`; `+(0********) for L/L+`
|===
...
|[[ehEquals]]equals | http://www.opengis.net/ont/geosparql#ehEquals[`geo:ehEquals`] | <<SpatialObject, SpatialObject>> | `All` | `(TFFFTFFFT)`
|[[ehDisjoint]]disjoint | http://www.opengis.net/ont/geosparql#ehDisjoint[`geo:ehDisjoint`] | <<SpatialObject, SpatialObject>> | `All` | `+(FF*FF****)+`
|[[ehMeet]]meet | http://www.opengis.net/ont/geosparql#ehMeet[`geo:ehMeet`] | <<SpatialObject, SpatialObject>> | `All except P/P` | `+(FT******* F**T***** F***T****)+`
|[[ehOverlap]]overlap | http://www.opengis.net/ont/geosparql#ehOverlap[`geo:ehOverlap`] | <<SpatialObject, SpatialObject>> | `All` | `+(T*T***T**)+`
|[[ehCovers]]covers | http://www.opengis.net/ont/geosparql#ehCovers[`geo:ehCovers`] | <<SpatialObject, SpatialObject>> | `A/A, A/L, L/L` | `+(T*TFT*FF*)+`
|[[ehCoveredBy]]covered by | http://www.opengis.net/ont/geosparql#ehCoveredBy[`geo:ehCoveredBy`] | <<SpatialObject, SpatialObject>> | `A/A, L/A, L/L` | `+(TFF*TFT**)+`
|[[ehInside]]inside | http://www.opengis.net/ont/geosparql#ehInside[`geo:ehInside`] | <<SpatialObject, SpatialObject>> | `All` | `+(TFF*FFT**)+`
|[[ehContains]]contains | http://www.opengis.net/ont/geosparql#ehContains[`geo:ehContains`] | <<SpatialObject, SpatialObject>> | `All` | `+(T*TFF*FF*)+`
|===
...
Topological relations in the _RCC8_ family are summarized in <<rcc8_relations, rcc8_relations>>.
...
|[[rcc8eq]]equals | http://www.opengis.net/ont/geosparql#rcc8eq[`geo:rcc8eq`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(TFFFTFFFT)`
|[[rcc8dc]]disconnected | http://www.opengis.net/ont/geosparql#rcc8dc[`geo:rcc8dc`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(FFTFFTTTT)`
|[[rcc8ec]]externally connected | http://www.opengis.net/ont/geosparql#rcc8ec[`geo:rcc8ec`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(FFTFTTTTT)`
|[[rcc8po]]partially overlapping | http://www.opengis.net/ont/geosparql#rcc8po[`geo:rcc8po`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(TTTTTTTTT)`
|[[rcc8tppi]]tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc8tppi[`geo:rcc8tppi`] | <<SpatialObject, SpatialObject>>  | `A/A`  | `(TTTFTTFFT)`
|[[rcc8tpp]]tangential proper part | http://www.opengis.net/ont/geosparql#rcc8tpp[`geo:rcc8tpp`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(TFFTTFTTT)`
|[[rcc8ntpp]]non-tangential proper part | http://www.opengis.net/ont/geosparql#rcc8ntpp[`geo:rcc8ntpp`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(TFFTFFTTT)`
|[[rcc8ntppi]]non-tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc8ntppi[`geo:rcc8ntppi`] | <<SpatialObject, SpatialObject>>  | `A/A` | `(TTTFFTFFT)`
|===
