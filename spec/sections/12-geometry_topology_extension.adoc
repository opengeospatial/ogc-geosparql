...
[requirement,identifier="/req/geometry-topology-extension/sf-query-functions",classification=2D-Functions]
...
[requirement,identifier="/req/geometry-topology-extension/eh-query-functions",classification=2D-Functions]
...
[requirement,identifier="/req/geometry-topology-extension/rcc8-query-functions",classification=2D-Functions,guidance=2D-Functions]
