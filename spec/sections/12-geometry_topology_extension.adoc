...
=== Simple Features Relation Family 3D Extensions

This clause establishes Requirements for extensions of the _Simple Features_ relation family to support 3D.

[[req_geometry-topology-extension_sf-query-functions]]
[requirement,identifier="/req/geometry-topology-extension/sf-query-functions"]
.Simple Features 3D Query Functions
====
Implementations shall support 
http://www.opengis.net/def/function/geosparql/sfIntersects3D[`geof:sfIntersects3D`], 
http://www.opengis.net/def/function/geosparql/sfContains3D[`geof:sfContains3D`], 
http://www.opengis.net/def/function/geosparql/sfWithin3D[`geof:sfWithin3D`]
as SPARQL extension functions, consistent with their corresponding DE-9IM intersection patterns, as defined by Simple Features <<OGCSFACA>> <<ISO19125-1>>.
====
