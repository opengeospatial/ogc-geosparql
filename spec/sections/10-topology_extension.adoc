...
This clause defines Requirements for the region connection calculus basic 9 (_RCC9_) relation family. The reader should consult references <<QUAL>> and <<LOGIC>> for a more detailed discussion of _RCC8_ relations.
...
Topological relations in the _RCC9_ family are summarized in <<rcc8_relations>>.
...
=== Equivalent RCC9, Egenhofer and Simple Features Topological Relations
