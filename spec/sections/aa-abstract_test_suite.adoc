...
They may be stated as part of a SPARQL 1.1 Service Description <<W3C_REC-sparql11-service-description-20130321>> .
...
reference:: <<W3C_REC-sparql11-protocol-20130321>>
====
...
test-purpose:: Check conformance with this requirement
test-method:: Verify that queries involving <<Property: geo:hasGeometry, `geo:hasGeometry`>>, <<Property: geo:hasDefaultGeometry, `geo:hasDefaultGeometry`>>, <<Property: geo:hasCentroid, `geo:hasCentroid`>> and <<Property: geo:hasBoundingBox, `geo:hasBoundingBox`>> return the correct result for a test dataset.
test-method-type:: Capabilities
