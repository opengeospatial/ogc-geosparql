...
The datatype http://www.opengis.net/ont/geosparql#kmlLiteral[`geo:geocodeLiteral`] is used to contain a geocode serialization of a Geometry.
...
[source,turtle]
----
"<https://w3id.org/geohashes/geohash> r7hue3x9jepv"^^geo:geoHasLiteral"^^<http://www.opengis.net/ont/geosparql#geocodeLiteral>
----
