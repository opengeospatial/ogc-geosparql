...
[NOTE,keep-separate=true]
====
This function is similar in nature to <<Function: geof:envelope, geof:envelope>> used to calculate the bounding box of just one geometry.
====
...
[NOTE,keep-separate=true]
====
This function is similar in name to <<Function: geof:boundingCircle, geof:boundingCircle>> used to calculate the bounding circle of just one geometry.
====
...
[NOTE,keep-separate=true]
====
This function is similar in name to <<Function: geof:centroid, geof:centroid>> used to calculate the centroid of just one geometry.
====
...
[NOTE,keep-separate=true]
====
This function is similar in name to <<Function: geof:concaveHull, geof:concaveHull>> used to calculate the concave hull of just one geometry.
====
