...
[#req_rdfs_entailment_extension_bgp_rdfs_ent]
|===
...
[#req_rdfs_entailment_extension_wkt_geometry_types]
|===
...
[#req_rdfs_entailment_extension_gml_geometry_types]
|===
