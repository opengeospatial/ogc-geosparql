...
* *Proper usage of GeoSPARQL classes*: These Shapes check for proper usage of instances of GeoSPARQL classes. For example, we check that instances of collection classes should at least have one element and that instances of Geometry classes should at least have one serialization to avoid creating graphs which contain nodes without necessary information.
...
| <<req_core_feature_properties, REQ 7: Feature Properties>>, <<req_geometry_extension_geometry_properties, REQ 13: Geometry Properties>>
...
| <<req_geometry-extension_geometry_properties, REQ 13: Geometry Properties>> <<req_geometry_extension_wkt_literal, REQ 14: WKT Literal>>
...
| <<req_geometry-extension_geometry_properties, REQ 13: Geometry Properties>> <<req_geometry_extension_gml_literal, REQ 20: GML Literal>>
...
| <<req_geometry_extension_geometry_properties, REQ 13: Geometry Properties>> <<req_geometry_extension_geojson_literal, REQ 25: GeoJSON Literal>>
...
| <<req_geometry_extension_geometry_properties, REQ 13: Geometry Properties>> <<req_geometry_extension_kml_literal, REQ 30: KML Literal>>
...
| <<req_geometry_extension_geometry_properties, REQ 13: Geometry Properties>>
...
| <<req_core_feature_properties, REQ 7: Feature Properties>>
...
| <<req_geometry_extension_wkt_literal, REQ 14: WKT Literal>>
...
| <<req_geometry_extension_gml_literal, REQ 20: GML Literal>>
...
| <<req_geometry_extension_geojson_literal, REQ 25: GeoJSON Literal>>
...
| <<req_geometry_extension_kml_literal, REQ 30: KML Literal>>
...
| <<req_core_feature_collection_class, REQ 5: Feature Collection Class>>
...
| <<req_geometry_extension_geometry_collection_class, REQ 12: Geometry Collection Class>>
...
| <<req_core_spatial_object_collection_class, REQ 4: Spatial Object Collection Class>>
