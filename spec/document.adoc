...
|Approval Date: 2023-08-13
|Publication Date: 2024-MM-DD
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/geosparql/1.1
|Internal reference number of this OGC(R) document: 22-047r1
|Version: 1.1
...
include::sections/03-title.adoc[]
...
include::sections/06-normative-references.adoc[]

include::sections/07-terms-definitions.adoc[]

include::sections/08-conventions.adoc[]

include::sections/09-core.adoc[]

include::sections/10-topology-extension.adoc[]

include::sections/11-geometry-extension.adoc[]

include::sections/12-geometry-topology-extension.adoc[]

include::sections/13-rdfs-entailment-extension.adoc[]

include::sections/14-query-rewrite-extension.adoc[]

include::sections/15-future-work.adoc[]

:sectnums!:

include::sections/aa-abstract-test-suite.adoc[]

include::sections/ab-functions-summary.adoc[]

include::sections/ac-examples.adoc[]

include::sections/ad-shacl-shapes.adoc[]

include::sections/ae-alignments.adoc[]

include::sections/af-cql-geosparql-mapping.adoc[]

include::sections/ag-revision-history.adoc[]
