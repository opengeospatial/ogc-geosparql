...
NOTE: The GeoSPARQL 1.1 Standard contains a RIF rules artefact expanded for all functions generated from this template and Python software for re-issuing the expanded artefact. See <<GeoSPARQL Standard structure>>.
