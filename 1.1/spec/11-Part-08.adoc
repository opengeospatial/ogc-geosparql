...
|===
| *Req 29* An empty RDFS Literal of type http://www.opengis.net/ont/geosparql#dggsLiteral[`geo:dggsLiteral`], or one of its sud datatypes, shall be interpreted as an empty geometry.
