...
|http://www.opengis.net/spec/geosparql/1.1/req/geometry-extension/non-sf-query-functions[`http://www.opengis.net/spec/geosparql/1.1/req/geometry-extension/non-sf-query-functions`]
|===
...
as SPARQL extension functions which are defined in this standard, for non-DGGS geometry literals
|http://www.opengis.net/spec/geosparql/1.1/req/geometry-extension/non-sf-query-functions-dggs[`http://www.opengis.net/spec/geosparql/1.1/req/geometry-extension/non-sf-query-functions-dggs`]
|===
