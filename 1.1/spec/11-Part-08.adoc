...
In addition, the following behaviors should be followed by all functions defined in the GeoSPARQL standard, unless otherwise stated in the function description:
