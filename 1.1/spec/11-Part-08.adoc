...
geo:hasBoundingBox a rdf:Property, owl:ObjectProperty ;
    ...
    skos:definition "Bounding-box or envelope of a given feature."@en ; 
	skos:scopeNote "The target geometry shall describe a rectilinear region whose edges are aligned with the axes of the coordinate reference system"@en ;
    rdfs:subPropertyOf geo:hasGeometry;
    rdfs:range geo:Geometry .
```
...
geo:hasCentroid a rdf:Property, owl:ObjectProperty ;
    rdfs:isDefinedBy geo: ;
    skos:prefLabel "has Bounding-Box"@en ;
    skos:definition "Centroid of a given feature."@en ; 
