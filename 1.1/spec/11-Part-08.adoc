...
```
geof:BBOX (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
...
```
geof:Centroid (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
...
```
geof:Concat_Lines (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
...
```
geof:ConcaveHull (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
...
```
geof:ConvexHull (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
...
```
geof:Union (geom: Set<ogc:geomLiteral>): ogc:geomLiteral
```
