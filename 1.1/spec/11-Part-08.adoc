...
This clause establishes the _Geometry Extension_ parameterized Requirements with base IRI `/req/geometry-extension`, which have a single corresponding conformance class _Geometry Extension_, with IRI `/conf/geometry-extension`. These Requirements defines a vocabulary for asserting and querying information about geometry data, and defines query functions for operating on geometry data.
