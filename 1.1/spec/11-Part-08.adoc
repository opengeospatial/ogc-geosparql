...
http://www.opengis.net/def/function/geosparql/minY[`geof:minY`], 
...
<<Function: geof:boundingBox,`geof:boundingBox`>>, 
<<Function: geof:boundingCircle,`geof:boundingCircle`>>, 
<<Function: geof:centroid,`geof:centroid`>>, 
<<Function: geof:concatLines,`geof:concatLines`>>, 
<<Function: geof:concaveHull,`geof:concaveHull`>>, 
<<Function: geof:convexHull,`geof:convexHull`>> and 
<<Function: geof:union2,`geof:union2`>> as a SPARQL extension functions.
...
The function http://www.opengis.net/def/function/geosparql/boundingBox[`geof:boundingBox`] calculates a minimum bounding box - rectangle - of the set of given geometries.
...
==== Function: geof:convexHull2

```
geof:convexHull2 (geom: ogc:geomLiteral): ogc:geomLiteral
```

The function http://www.opengis.net/def/function/geosparql/convexHull2[`geof:convexHull2`] calculates the convex hull of the set of given geometries.
