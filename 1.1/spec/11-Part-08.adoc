...
```
geof:minBoundingCircle (ogc:geomLiteral): ogc:geomLiteral
```
The function http://www.opengis.net/def/function/geosparql/minBoundingCircle[`geof:minBoundingCircle`] calculates a minimum bounding circle of the set of given geometries.
