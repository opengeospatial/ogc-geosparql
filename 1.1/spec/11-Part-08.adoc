...
<<Property: geo:geo:hasSpatialResolution, `geo:hasSpatialResolution`>>, 
<<Property: geo:geo:hasMetricSpatialResolution, `geo:hasMetricSpatialResolution`>>, 
<<Property: geo:geo:hasSpatialAccuracy, `geo:hasSpatialAccuracy`>>, 
<<Property: geo:geo:hasMetricSpatialAccuracy, `geo:hasMetricSpatialAccuracy`>>, 
