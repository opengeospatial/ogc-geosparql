...
They include one or many http://www.opengis.net/ont/geosparql#hasGeometry[geo:hasGeometry] relations and further properties related to the geospatial feature. 
