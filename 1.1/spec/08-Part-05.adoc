...
Three RDF serializations are used in this document. Terse RDF Triple Language <<TURTLE, turtle>> is used for RDF snippets placed within the main body of the document, and turtle,  <<JSON-LD, JSON-LD>> & <<RDFXML, RDF/XML>> are used for the examples in _Annex B — GeoSPARQL Examples_.
