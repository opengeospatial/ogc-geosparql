= Annex D - Alignments (informative)
...
== D.1 ISA Programme Location Core Vocabulary (LOCN)
...
== D.2 WGS84 Geo Positioning: an RDF vocabulary (POS)
...
== D.8 Semantic Sensor Network Ontology (SSN)
...
== D.9 DCMI Metadata Terms (DCTERMS)
...
== D.10 The Provenance Ontology (PROV)
