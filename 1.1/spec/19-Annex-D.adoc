...
|http://www.opengis.net/def/geosparql/validator/S21-geometryClass-hasGeometry-hasSerialization[Shape 21]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S22-FeatureCollectionClass-minOneMember-feature-sub[Shape 22a]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S22-FeatureCollectionClass-member-onlyFeature-sub[Shape 22b]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S23-GeometryCollectionClass-minOneMember-geometry-sub[Shape 23a]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S23-GeometryCollectionClass-member-onlyGeometry-sub[Shape 23b]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S24-SpatialObjectCollection-minOneMember-spatialObject-sub[Shape 24a]
| Violation
...
|http://www.opengis.net/def/geosparql/validator/S24-SpatialObjectCollection-member-onlySpatialObject-sub[Shape 24b]
| Violation
