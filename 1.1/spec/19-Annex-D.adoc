...
|S33-FeatureCollectionClass-minOneMember-feature-sub[Shape 33a]
| Violation
...
|S33-FeatureCollectionClass-member-onlyFeature-sub[Shape 33b]
| Violation
...
|S34-GeometryCollectionClass-minOneMember-geometry-sub[Shape 34a]
| Violation
...
|S34-GeometryCollectionClass-member-onlyGeometry-sub[Shape 34b]
| Violation
...
|S35-SpatialObjectCollection-minOneMember-spatialObject-sub[Shape 35a]
| Violation
...
|S35-SpatialObjectCollection-member-onlySpatialObject-sub[Shape 35b]
| Violation
