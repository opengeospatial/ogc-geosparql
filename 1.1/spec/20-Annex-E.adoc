...
| http://purl.obolibrary.org/obo/BFO_0000029[`obo:BFO_0000029`] "site" | http://www.w3.org/2000/01/rdf-schema#subClassOf[`rdfs:subClassOf`] | <<Class: geo:Feature, `geo:Feature`>> | BFO's sites either covert the same areas as or have locations determined in relation to material entities so sites are Features but not necessarily the other way around
