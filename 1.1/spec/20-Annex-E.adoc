...
* http://purl.org/dc/terms/spatial[`dcterms:spatial`]: "Spatial characteristics of the resource". The range of this property includes a http://purl.org/dc/terms/Location[`dcterms:Location`], so it is a property for indicating a <<Class: geo:Feature, `geo:Feature`>>, not a <<Class: geo:Geometry, `geo:Geometry`>> and for which GeoSPARQL has no equivalent.
