...
| http://geovocab.org/spatial#C[`spatial:C`] | http://www.w3.org/2000/01/rdf-schema#subPropertyOf[`rdfs:subPropertyOf`] | <<Property: geo:rcc8ec, `geo:rcc8ec`>> | Subproperty not equivalent property since the NeoGeo property has more restrictive domain & range
