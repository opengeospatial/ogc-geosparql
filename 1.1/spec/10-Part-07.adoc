...
|===
|Function Name | Description | Return Value |  Reference

|geosf:MinX(sf:Geometry) | Returns the minimum X coordinate of all geometries | xsd:double | 
|geosf:MaxX(sf:Geometry) | Returns the maximum X coordinate of all geometries | xsd:double | 
|geosf:MinY(sf:Geometry) | Returns the minimum Y coordinate of all geometries | xsd:double | 
|geosf:MaxY(sf:Geometry) | Returns the maximum Y coordinate of all geometries | xsd:double | 
|geosf:MinZ(sf:Geometry) | Returns the minimum Z coordinate of all geometries | xsd:double | 
|geosf:MaxZ(sf:Geometry) | Returns the maximum Z coordinate of all geometries | xsd:double | 
|geosf:BBOX(sf:Geometry) | Calculates a minimum bounding box of the set of given geometries |sf:Geometry | 
|geosf:Centroid(sf:Geometry) | Calculates the centroid of the set of given geometries | sf:Point | 
|geosf:Concat_Lines(sf:LineString) | Concatenates a set of LineStrings | sf:Geometry | 
|geosf:ConcaveHull(sf:Geometry) | Calculates the concave hull of the set of given geometries | sf:Geometry | 
|geosf:ConvexHull(sf:Geometry) | Calculates the convex hull of the set of given geometries | sf:Geometry | 
|geosf:Union(sf:Geometry) | Calculates the union of the set of given geometries   | sf:Geometry | 
|===
