...
[[annexB_example6]]
*Example 5*: Spatial Aggregate Functions I: Calculate the boundingbox, convexhull .

```sparql
PREFIX geo: <http://www.opengis.net/ont/geosparql#>
PREFIX geof: <http://www.opengis.net/def/geosparql/function>

SELECT (geof:convexHull(?testgeom) AS ?convexHull) (geof:buffer(?testgeom) AS ?buffer) (geof:centroid(?testgeom) AS ?centroid)
(geof:concaveHull(?testgeom) AS ?concaveHull) (geof:concat(?testgeom) AS ?concaveHull)
WHERE { 
    BIND ("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> 
           POLYGON((-91.31835937500001 46.31658418182218,-77.080078125 39.027718840211605,-85.4296875 37.92686760148135,-84.11132812500001 40.780541431860286,-89.6484375 43.64402584769951,-90.08789062500001 41.57436130598913,-89.20898437500001 37.996162679728116,-91.845703125 39.4361929993141,-92.63671875 44.964797930331,-94.48242187499999 44.02442151965934,-96.767578125 46.13417004624324,-96.943359375 51.0137546571882,-90.439453125 51.12421275782688,-86.39648437500001 49.38237278700956,-83.49609375 46.49839225859765,-91.31835937500001 46.31658418182218)))"^^geo:wktLiteral") AS ?testgeom)
}
```

*Result*:
|===
|*?convexHull* | *?buffer* | *?centroid* | *?concaveHull* | *?BBOX* | *?concatLines*

|`POLYGON ((-85.4296875 37.9268676014813,-89.208984375 37.9961626797281,-91.845703125 39.4361929993141,-96.767578125 46.1341700462432,-96.943359375 51.0137546571882,-90.439453125 51.1242127578269,-86.396484375 49.3823727870096,-83.49609375 46.4983922585976,-77.080078125 39.0277188402116,-85.4296875 37.9268676014813))` | `` | `POINT (-89.4431017481891 45.2393721039478)` | `POLYGON ((-85.4296875 37.9268676014813,-84.111328125 40.7805414318603,-77.080078125 39.0277188402116,-83.49609375 46.4983922585976,-86.396484375 49.3823727870096,-90.439453125 51.1242127578269,-96.943359375 51.0137546571882,-96.767578125 46.1341700462432,-94.482421875 44.0244215196593,-91.845703125 39.4361929993141,-89.208984375 37.9961626797281,-85.4296875 37.9268676014813))` | `` | ``
|===
