= Annex B - GeoSPARQL Examples (informative)
...
== B.0 Function Overview ==

[cols="1,1,1,1,1,1,1,1,1"]
|===
| Function Name  | Input  Parameters | Input Types | Output  Datatype | Output Datatype Subtypes | 2D  | 3D  | Comment |
...
| geof:area  | 1x ogc:geomLiteral  | | xsd:double | xsd:double  | Yes  |  No | |
| geof:asDGGS  | 1x ogc:geomLiteral  | | geo:dggsLiteral | geo:dggsLiteral  | Yes  |  Yes | |
| geof:asGeoJSON  | 1x ogc:geomLiteral | | geo:geoJSONLiteral | geo:geoJSONLiteral  | Yes  |  Yes | |
| geof:asGML  | 1x ogc:geomLiteral, 1x  xsd:string | | geo:gmlLiteral | geo:gmlLiteral  | Yes  |  Yes | |
| geof:asKML  | 1x ogc:geomLiteral  | | geo:kmlLiteral | geo:kmlLiteral  | Yes  |  Yes | |
| geof:asWKT  | 1x ogc:geomLiteral  | | geo:wktLiteral | geo:wktLiteral  | Yes  |  Yes | |
| geof:boundary | 1x ogc:geomLiteral  | | ogc:geomLiteral | LineString(GeoJSON,WKT,GML,KML)   | Yes  |  Yes | |
| geof:buffer | 1x ogc:geomLiteral, 1x xsd:anyURI | | ogc:geomLiteral | (Multi)Polygon(GeoJSON,WKT,GML,KML) | Yes  |  Yes | |
| geof:difference | 2x ogc:geomLiteral | | ogc:geomLiteral | (Multi)Polygon(GeoJSON,WKT,GML,KML)   | Yes  |  Yes | |
| geof:dimension  | 1x ogc:geomLiteral | | xsd:double | xsd:double  | Yes  |  Yes | |
| geof:distance  | 1x ogc:geomLiteral  | | xsd:double | xsd:double  | Yes  |  Yes | |
| geof:ehContains  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:ehCoveredBy  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:ehCovers  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:ehDisjoint  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:ehEquals  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
...
| geof:getSRID  | 1x ogc:geomLiteral  | | xsd:anyURI |  xsd:anyURI | Yes | Yes | |
| geof:intersection  | 2x ogc:geomLiteral  | | ogc:geomLiteral | Polygon(GeoJSON,WKT,GML,KML)  | Yes  |  Yes | |
| geof:isEmpty | 1x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:isSimple | 1x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:maxX | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:maxY | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:maxZ | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:minX | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:minY | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:minZ | 1x ogc:geomLiteral  | | xsd:double  | xsd:double  | Yes | Yes | |
| geof:union  | 2x ogc:geomLiteral  | | ogc:geomLiteral  | Polygon(GeoJSON,WKT,GML,KML)  | Yes | Yes | |
...
| geof:sfContains  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfCrosses  | 2x ogc:geomLiteral | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfDisjoint  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfEquals  | 2x ogc:geomLiteral | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfIntersects  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfOverlaps  | 2x ogc:geomLiteral | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfTouches  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:sfWithin  | 2x ogc:geomLiteral  | | xsd:boolean |  true,false,1,0 | Yes | Yes | |
| geof:symDifference | 2x ogc:geomLiteral | | (Multi)Polygon(GeoJSON,WKT,GML,KML)   | Yes  |  Yes | |
|===
...
==== B.1.2.1 Spatial Object Properties

See the section <<B.1.1.1.2 Size Properties>> above.

==== B.1.2.2 Feature Properties
...
<<Property: geo:hasMetricSize, `geo:hasMetricSize`>> and <<Property: geo:hasSize, `geo:hasSize`>>, that are intended to be used through their subproperties and <<Property: geo:hasMetricPerimeterLength, `geo:hasMetricPerimeterLength`>> and <<Property: geo:hasPerimeterLength, `geo:hasPerimeterLength`>> which are examplified in <<B.1.1.1.2 Size Properties>>.
...
==== B.1.2.4 Geometry Serializations
