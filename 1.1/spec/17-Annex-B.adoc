...
eg:x a geo:Feature ;
    ...
    geo:metricArea 8.7E4^^xsd:double;
.
```
...
===== B 1.1.2.7 `Feature` with two different `Geometry` instances with metric spatial resolution

```turtle
eg:x a geo:Feature ;
    skos:prefLabel "Feature X";
    geo:hasGeometry [
        geo:metricSpatialResolution 100^^xsd:float ;
        geo:asWKT "MULTIPOLYGON (((149.06016 -35.23610, 149.060620 -35.236043, ... , 149.06016 -35.23610)))"^^geo:wktLiteral ;
    ] ,
    [
        geo:metricSpatialResolution 5^^xsd:float ;
        geo:asWKT "MULTIPOLYGON (((149.06016597 -35.23610603, 149.060620715 -35.236043435, ... , 149.06016597 -35.23610603)))"^^geo:wktLiteral ;
    ] ;
.
```
