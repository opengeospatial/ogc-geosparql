...
==== Property: geo:metricLength
The property http://www.opengis.net/ont/geosparql#metricLength[`geo:metricLength`] is similar to http://www.opengis.net/ont/geosparql#hasLength[`geo:hasLength`], but is easier to specify and use because the unit is always meter (the standard length unit of the International System of Units).

```turtle
geo:metricLength a rdf:Property, owl:DatatypeProperty ;
    rdfs:isDefinedBy geo: ;
...
==== Property: geo:metricArea
The property http://www.opengis.net/ont/geosparql#metricArea[`geo:metricArea`] is similar to http://www.opengis.net/ont/geosparql#hasArea[`geo:hasArea`], but is easier to specify and use because the unit is always square meter (the standard area unit of the International System of Units).

```turtle
geo:metricArea a rdf:Property, owl:DatatypeProperty ;
    rdfs:isDefinedBy geo: ;
...
==== Property: geo:metricVolume
The property http://www.opengis.net/ont/geosparql#metricVolume[`geo:metricVolume`] is similar to http://www.opengis.net/ont/geosparql#hasVolume[`geo:hasVolume`], but is easier to specify and use because the unit is always cubic meter (the standard volume unit of the International System of Units).

```turtle
geo:metricVolume a rdf:Property, owl:DatatypeProperty ;
    rdfs:isDefinedBy geo: ;
    skos:prefLabel "metric volume"@en ;
