...
2+|_**Classes**_
|Spatial Object Collection class | <<Class: geo:SpatialObjectCollection, Class: geo:SpatialObjectCollection>>
|Feature Collection class | <<Class: geo:FeatureCollection, Class: geo:FeatureCollection>>
|Geometry Collection class | <<Class: geo:GeometryCollection, Class: geo:GeometryCollection>>
2+|_**Spatial Object Properties**_
|hasSize | <<Property: geo:hasSize, Property: geo:hasSize>>
|hasMetricSize | <<Property: geo:hasMetricSize, Property: geo:hasMetricSize>>
|hasLength | <<Property: geo:hasLength, Property: geo:hasLength>>
|hasMetricLength | <<Property: geo:hasMetricLength, Property: geo:hasMetricLength>>
|hasPerimeterLength | <<Property: geo:hasPerimeterLength, Property: geo:hasPerimeterLength>>
|hasMetricPerimeterLength | <<Property: geo:hasMetricPerimeterLength, Property: geo:hasMetricPerimeterLength>>
|hasArea | <<Property: geo:hasArea, Property: geo:hasArea>>
|hasMetricArea | <<Property: geo:hasMetricArea, Property: geo:hasMetricArea>>
|hasVolume | <<Property: geo:hasVolume, Property: geo:hasVolume>>
|hasMetricVolume | <<Property: geo:hasMetricVolume, Property: geo:hasMetricVolume>>
2+|_**Feature Properties**_
|hasBoundingBox | <<Property: geo:hasBoundingBox, Property: geo:hasBoundingBox>>
|hasCentroid | <<Property: geo:hasCentroid, Property: geo:hasCentroid>>
2+|_**Geometry Serializations**_
|geoJSONLiteral | <<RDFS Datatype: geo:geoJSONLiteral, RDFS Datatype: geo:geoJSONLiteral>>
|asGeoJSON | <<Property: geo:asGeoJSON, Property: geo:asGeoJSON>>
|asGeoJSON function | <<Function: geof:asGeoJSON, Function: geof:asGeoJSON>>
|kmlLiteral | <<RDFS Datatype: geo:kmlLiteral, RDFS Datatype: geo:kmlLiteral>>
|asKML | <<Property: geo:asKML, Property: geo:asKML>>
|asKML function | <<Function: geof:asKML, Function: geof:asKML>>
|dggsLiteral | <<RDFS Datatype: geo:dggsLiteral, RDFS Datatype: geo:dggsLiteral>>
|asDGGS | <<Property: geo:asDGGS, Property: geo:asDGGS>>
|asDGGS function | <<Function: geof:asDGGS, Function: geof:asDGGS>>
2+|_**Non-topological Query Functions**_
|maxX | <<Function: geof:maxX, Function: geof:maxX>>
|maxY | <<Function: geof:maxY, Function: geof:maxY>>
|maxZ | <<Function: geof:maxZ, Function: geof:maxZ>>
|minX | <<Function: geof:minX, Function: geof:minX>>
|minY | <<Function: geof:minY, Function: geof:minY>>
|minZ | <<Function: geof:minZ, Function: geof:minZ>>
2+|_**Spatial Aggregate Functions**_
|aggBoundingBox | <<Function: geof:aggBoundingBox, Function: geof:aggBoundingBox>>
|aggBoundingCircle | <<Function: geof:aggBoundingCircle, Function: geof:aggBoundingCircle>>
|aggCentroid | <<Function: geof:aggCentroid, Function: geof:aggCentroid>>
|aggConcatLines | <<Function: geof:aggConcatLines, Function: geof:aggConcatLines>>
|aggConcaveHull | <<Function: geof:aggConcaveHull, Function: geof:aggConcaveHull>>
|aggUnion | <<Function: geof:aggUnion, Function: geof:aggUnion>>
|===
