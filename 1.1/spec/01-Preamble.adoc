...
This document is only one part of the GeoSPARQL standard's resources that contain the above listed information. This document has the role of _specification_ and authoratitivly defines many of the standard's elements. Links to the standard's other resources, including information about the roles they play, are provided in this document and are described within the GeoSPARQL _Profile_ declaration:
