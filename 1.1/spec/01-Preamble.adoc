== Preface
This standard defines a set of SPARQL extension functions <<SPARQL>>, a set of RIF rules <<RIFCORE>>, and a core RDF/OWL [12,14,16] vocabulary for geographic information based on the General Feature Model <<ISO19109>>, Simple Features [ISO 19125-1], Feature Geometry <<ISO19107>> and SQL MM <<ISO13249>>.
