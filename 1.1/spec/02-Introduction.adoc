...
GeoSPARQL does not provide support for spatiotemporal data. Predicates for temporal relations may be used from the OWL Time ontology, but query extension functions for spatiotemporal operations are not present in the GeoSPARQL standard.
